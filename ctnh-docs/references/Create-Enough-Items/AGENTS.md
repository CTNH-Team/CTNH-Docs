...
|-------------|-------|-------------|
| `client` | `references/Create-Enough-Items/client/AGENTS.md` | ClientProxy |
| `common` | `references/Create-Enough-Items/common/AGENTS.md` | CommonProxy |
| `data` | `references/Create-Enough-Items/data/AGENTS.md` | CEIDatagen |
| `event` | `references/Create-Enough-Items/event/AGENTS.md` | ForgeClientEventHandler |
| `mixin` | `references/Create-Enough-Items/mixin/AGENTS.md` | EMI/Create/TMRV mixins and accessors |
| `registry` | `references/Create-Enough-Items/registry/AGENTS.md` | CEIRegistrate |
| `utils` | `references/Create-Enough-Items/utils/AGENTS.md` | EMI feature implementations |
