...
|-------------|-------|-------------|
| `api` | `references/CTNH-Energy/api/AGENTS.md` | Shared API surfaces |
| `client` | `references/CTNH-Energy/client/AGENTS.md` | Ponder plugin/scenes/tags, render |
| `common` | `references/CTNH-Energy/common/AGENTS.md` | AE2/EU logic, machines, quantum computer, proxy |
| `data` | `references/CTNH-Energy/data/AGENTS.md` | CEDatagen, lang |
| `event` | `references/CTNH-Energy/event/AGENTS.md` | Forge event handlers |
| `integration` | `references/CTNH-Energy/integration/AGENTS.md` | EMI, Jade, LDLib integration |
| `mixin` | `references/CTNH-Energy/mixin/AGENTS.md` | AE2/AECS/Better P2P/GTM/Omni patches |
| `network` | `references/CTNH-Energy/network/AGENTS.md` | Packets and sync data |
| `registry` | `references/CTNH-Energy/registry/AGENTS.md` | Items, blocks, machines, recipe types |
| `utils` | `references/CTNH-Energy/utils/AGENTS.md` | Shared helpers |
