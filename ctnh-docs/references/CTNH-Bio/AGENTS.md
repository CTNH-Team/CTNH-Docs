...
|-------------|-------|-------------|
| `api` | `references/CTNH-Bio/api/AGENTS.md` | Recipe capabilities, entity/model ingredients, machine APIs |
| `client` | `references/CTNH-Bio/client/AGENTS.md` | Renderers, models, GUI textures |
| `common` | `references/CTNH-Bio/common/AGENTS.md` | CommonProxy, conditions, items, recipes, serums |
| `data` | `references/CTNH-Bio/data/AGENTS.md` | Recipe generators, lang, loot, materials, tags |
| `event` | `references/CTNH-Bio/event/AGENTS.md` | EventHandler, ForgeEventHandler, TransformManager |
| `integration` | `references/CTNH-Bio/integration/AGENTS.md` | XEI/Jade/EMI/JEI integration |
| `machine` | `references/CTNH-Bio/machine/AGENTS.md` | Living-machine implementations |
| `mixin` | `references/CTNH-Bio/mixin/AGENTS.md` | Biomancy/HNN/EMI/Create/GTCEu patches |
| `registry` | `references/CTNH-Bio/registry/AGENTS.md` | Items, blocks, entities, machines, recipes |
| `utils` | `references/CTNH-Bio/utils/AGENTS.md` | Shared helpers |
