...
|-------------|-------|-------------|
| `api` | `references/CTNH-Astral/api/AGENTS.md` | Loot builder |
| `client` | `references/CTNH-Astral/client/AGENTS.md` | ClientProxy, RocketLaunchHud, MoonEffects |
| `common` | `references/CTNH-Astral/common/AGENTS.md` | CommonProxy, oxygen system, rockets, machines |
| `data` | `references/CTNH-Astral/data/AGENTS.md` | Materials, elements, worldgen, lang |
| `mixin` | `references/CTNH-Astral/mixin/AGENTS.md` | Ad Astra and chunk-generator hooks |
| `registry` | `references/CTNH-Astral/registry/AGENTS.md` | Blocks (incl. rocket/moon/mars), sounds |
| `utils` | `references/CTNH-Astral/utils/AGENTS.md` | ModUtils |
