...
|-------------|-------|-------------|
| `api` | `references/CTNH-Lib/api/AGENTS.md` | Shared values, cross-parallel recipe logic |
| `client` | `references/CTNH-Lib/client/AGENTS.md` | Highlight render, Ponder framework |
| `command` | `references/CTNH-Lib/command/AGENTS.md` | Chat helper, inspector, showores dev command |
| `common` | `references/CTNH-Lib/common/AGENTS.md` | CommonProxy, MultiblockHelper |
| `data` | `references/CTNH-Lib/data/AGENTS.md` | Dynamic datapack and filter packs |
| `langprovider` | `references/CTNH-Lib/langprovider/AGENTS.md` | @CN/@EN annotations and processor |
| `mixin` | `references/CTNH-Lib/mixin/AGENTS.md` | Builder adjustments, TMRV, datagen shutdown |
| `network` | `references/CTNH-Lib/network/AGENTS.md` | BlockHighlightPacket |
| `registrate` | `references/CTNH-Lib/registrate/AGENTS.md` | CNRegistrate and builder wrappers |
| `utils` | `references/CTNH-Lib/utils/AGENTS.md` | Shared helpers |
