...
## CONVENTIONS
- `CommonProxy` initializes `GTProvidersRegistrar`, `CTNHLibNetworking`, registers the runtime helper item through GTCEu's registrate, and adds the `ctnhlib:filter_data` server data pack source.
