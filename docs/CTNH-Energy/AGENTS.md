...
|   |-- me/                   # EUKey/VoltageKey (key/), EU cells (cell/), EU P2P (parts/p2p/), EnergyDistributeService (service/), EUContainerItemStrategy (strategy/)
...
|-- integration/              # emi/ (CEEMIPlugin, EUEmiStack, ...), jade/ (4 providers), ldlib/ (CELDLibPlugin)
...
`-- utils/                    # 12: CEDrawHelper, MEConfigUtil, ProviderRecord, button/ (4), ...
```
