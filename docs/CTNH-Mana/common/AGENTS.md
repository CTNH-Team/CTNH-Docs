...
## OVERVIEW
Shared implementation for Mana (97 Java files, the largest Mana domain): CommonProxy, rituals, items, machines, multiblocks, block entities, and recipe builders for Blood Magic/Botania.
...
|-- blockentity/
|   |-- flower/                # 8: AnattaLotusBlockEntity, BlackVeinMarigoldBlockEntity, BloodAntiarisBlockEntity, DemonFlytrapBlockEntity, GenethistleBlockEntity, ParaRosiaBlockEntity, TulpenmanieBlockEntity
|   `-- machine/               # 5: FlowerCakeBlockEntity, IManaMachineBlockEntity, IZenithMartixBlockEntity, MysticSpireBlockEntity, ZenithEyeBlockEntity
...
|-- item/
|   |-- FlowerCakeItem.java, TooltipsBlockItem.java
...
| Multiblocks | `common/multiblock/` (28) |
| Parts | `common/parts/`, `common/parts/ManaHatches/` |
| Machines | `common/machine/` (FlowerCake) |
| Block entities | `common/blockentity/flower/` (8), `common/blockentity/machine/` (5) |
| GUI | `common/gui/` (7) |
...
## READ WHEN
- Implementing rituals, magic items, machines, or recipe builders in Mana.
